...
export const getZPID = search => {
  var request = new Request(`https://cors-anywhere.herokuapp.com/https://www.zillow.com/webservice/GetSearchResults.htm?zws-id=${process.env.REACT_APP_ZWS_ID}&address=${encodeURIComponent(search.address)}&citystatezip=${encodeURIComponent(search.citystate)}`, {
    headers: new Headers({
